...
sentrnn.add(RNN(input_dim=EMBED_HIDDEN_SIZE, output_dim=SENT_HIDDEN_SIZE, return_sequences=False))

qrnn = Sequential()
qrnn.add(Embedding(input_dim=vocab_size, output_dim=EMBED_HIDDEN_SIZE))
qrnn.add(RNN(input_dim=EMBED_HIDDEN_SIZE, output_dim=QUERY_HIDDEN_SIZE, return_sequences=False))

model = Sequential()
model.add(Merge([sentrnn, qrnn], mode='concat'))
model.add(Dense(input_dim=SENT_HIDDEN_SIZE + QUERY_HIDDEN_SIZE, output_dim=vocab_size, activation='softmax'))
